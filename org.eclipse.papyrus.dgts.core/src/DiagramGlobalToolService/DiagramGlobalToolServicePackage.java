...
public interface DiagramGlobalToolServicePackage extends EPackage {
	...
	/**
         ...
         * @ordered
         */
        int TOOL_ELEMENT__NAME = 0;

        /**
         * The feature id for the '<em><b>IElement Type</b></em>' attribute.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
         * @ordered
	...
	/**
         * Returns the meta object for the attribute '{@link DiagramGlobalToolService.ToolElement#getName <em>Name</em>}'.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @return the meta object for the attribute '<em>Name</em>'.
         * @see DiagramGlobalToolService.ToolElement#getName()
         * @see #getToolElement()
         * @generated
         */
        EAttribute getToolElement_Name();

        /**
         * Returns the meta object for the attribute '{@link DiagramGlobalToolService.ToolElement#getIElementType <em>IElement Type</em>}'.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @return the meta object for the attribute '<em>IElement Type</em>'.
         * @see DiagramGlobalToolService.ToolElement#getIElementType()
         * @see #getToolElement()
         * @generated
         */
	...
	interface Literals {
		...
		/**
                 ...
                 * @generated
                 */
                EAttribute TOOL_ELEMENT__NAME = eINSTANCE.getToolElement_Name();

                /**
                 * The meta object literal for the '<em><b>IElement Type</b></em>' attribute feature.
                 * <!-- begin-user-doc -->
                 * <!-- end-user-doc -->
                 * @generated
                 */
