...
public class DiagramGlobalToolServiceAdapterFactory extends AdapterFactoryImpl {
        ...
        protected DiagramGlobalToolServiceSwitch<Adapter> modelSwitch =
                new DiagramGlobalToolServiceSwitch<Adapter>() {
                        ...
                        @Override
                        public Adapter caseToolMetaModel(ToolMetaModel object) {
                                return createToolMetaModelAdapter();
                        }
                        @Override
        ...
        /**
         * Creates a new adapter for an object of class '{@link DiagramGlobalToolService.AbstractTool <em>Abstract Tool</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
        ...
        /**
         * Creates a new adapter for an object of class '{@link DiagramGlobalToolService.Tool <em>Tool</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
        ...
        /**
         * Creates a new adapter for an object of class '{@link DiagramGlobalToolService.ElementType <em>Element Type</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
        ...
        /**
         * Creates a new adapter for an object of class '{@link DiagramGlobalToolService.ToolMetaModel <em>Tool Meta Model</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
         ...
         * @generated
         */
        public Adapter createToolMetaModelAdapter() {
                return null;
        }
