...
public class DiagramGlobalToolServicePackageImpl extends EPackageImpl implements DiagramGlobalToolServicePackage {
	 ...
	 * @generated
	 */
	public EAttribute getDiagramDefinition_SetPalette() {
		return (EAttribute)diagramDefinitionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDiagramDefinition_SetPopup() {
	 ...
	 * @generated
	 */
	public EAttribute getDiagramDefinition_SetMenu() {
	 ...
	 */
		...
		createEAttribute(diagramDefinitionEClass, DIAGRAM_DEFINITION__SET_PALETTE);
		createEAttribute(diagramDefinitionEClass, DIAGRAM_DEFINITION__SET_POPUP);
		createEAttribute(diagramDefinitionEClass, DIAGRAM_DEFINITION__SET_MENU);
	 ...
	 */
		...
		initEAttribute(getDiagramDefinition_SetPalette(), theEcorePackage.getEBoolean(), "setPalette", "true", 0, 1, DiagramDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramDefinition_SetPopup(), theEcorePackage.getEBoolean(), "setPopup", "true", 0, 1, DiagramDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramDefinition_SetMenu(), theEcorePackage.getEBoolean(), "setMenu", "true", 0, 1, DiagramDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
