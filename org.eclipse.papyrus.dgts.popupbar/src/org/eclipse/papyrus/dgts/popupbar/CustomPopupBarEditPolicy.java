...
public class CustomPopupBarEditPolicy extends GraphicalEditPolicy{
    ...
    private class TestPopupBarKeyListener implements org.eclipse.draw2d.KeyListener {
    ...
    private class PopupBarKeyHandler extends KeyHandler {
    ...
    private PopupBarMouseMotionListener myMouseMotionListener = new PopupBarMouseMotionListener();
    
    private PopupBarKeyListener myPopupBarKeyListener = new PopupBarKeyListener();
    
    private TestPopupBarKeyListener myTestPopupBarKeyListener = new TestPopupBarKeyListener();
    
    
    
    private PopupBarKeyHandler myPopupBarKeyHandler = new PopupBarKeyHandler();
	...
	//getHostFigure().addKeyListener(this.myTestPopupBarKeyListener);
