...
/**
 * This class is insprired by ConnectionHandleLocator from cmahoney
 ...
 * @author gdesq
 */
public class DgtsConnectionHandleLocator implements Locator {

	/** number of pixels between connection handles */
	private static int HANDLE_SPACING = 16;
	...
	private List<CustomConnectionHandle> handles = new ArrayList<CustomConnectionHandle>();
	 ...
	 */
	public DgtsConnectionHandleLocator(IFigure reference, Point cursorPosition) {
	 ...
	 */
	public void addHandle(CustomConnectionHandle handle) {
		handles.add(handle);
	}
	...
	protected void resetBorderPointAndSide() {
		...
		int northDiff = isEastWestSouth() ? Integer.MAX_VALUE : cursorPosition.y - bounds.y;
	...
	public void relocate(IFigure target) {
		...
		if(side == PositionConstants.WEST) {
			...
			target.setLocation(borderPointTranslated.getTranslated(new Dimension(-halfWidth, -height - MARGIN)));
		}
