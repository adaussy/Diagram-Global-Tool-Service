 ...
 * @author cmahoney
 */
public class CustomConnectionHandleTool
	...
	protected Request createTargetRequest() {
		if (getConnectionHandle().isIncoming()) {
			CreateUnspecifiedTypeConnectionRequest request = new CreateUnspecifiedTypeConnectionRequest(
				CustomModelingAssistantService.getInstance().getRelTypesOnTarget(
			...
			return new CreateUnspecifiedTypeConnectionRequest(
				CustomModelingAssistantService.getInstance().getRelTypesOnSource(
					getConnectionHandle().getOwner()), true,
				getPreferencesHint());
		}
	}
	...
	protected List executeShowRelatedElementsCommand() {
		...
		List popupContent = getConnectionHandle().isIncoming() ? CustomModelingAssistantService
			.getInstance().getRelTypesForSREOnTarget(targetEP)
			: CustomModelingAssistantService.getInstance().getRelTypesForSREOnSource(
				targetEP);
        ...
        try {
            ...
            Trace.catching(DiagramUIPlugin.getInstance(),
                ...
                CustomConnectionHandleTool.class,
