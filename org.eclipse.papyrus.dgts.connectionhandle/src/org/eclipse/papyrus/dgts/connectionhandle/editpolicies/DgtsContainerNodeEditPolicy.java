 ...
 * @author cmahoney
 */
public class DgtsContainerNodeEditPolicy
	extends DgtsGraphicalNodeEditPolicy {
	...
	protected Command getConnectionAndEndCommands(
		...
		boolean isDirectionReversed = request instanceof DgtsCreateUnspecifiedTypeConnectionRequest
			&& ((DgtsCreateUnspecifiedTypeConnectionRequest) request)
				.isDirectionReversed();
