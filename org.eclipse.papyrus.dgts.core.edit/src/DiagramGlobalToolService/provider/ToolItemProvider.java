		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Tool_isEdge_feature", "_UI_Tool_type"),
				 DiagramGlobalToolServicePackage.Literals.TOOL__IS_EDGE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramGlobalToolServicePackage.Literals.TOOL__NAME,
				 true,
				 false,
				 false,
